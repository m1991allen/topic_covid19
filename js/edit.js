...
case_data.list = [
    {
        ...
        group: 'trp_NA',
        info: '《案640》' + '<br>' + `
            本國籍30多歲男性，長期在美國工作（前次自台灣出境日期為2019年9月），11月20日返臺探親，入境時無症狀，並至防疫旅館居家檢疫。個案11月21日起陸續出現疲倦、喉嚨乾、喉嚨痛等症狀，11月25日通報衛生單位安排就醫採檢，於今（27）日確診。
        ...
        group: 'trp_NA',
        info: '《案645》' + '<br>' + `
            本國籍40多歲女性，長期居住美國（前次自臺灣出境日期為2019年11月），因計劃返台探親，今年11月19日入境，迄今無疑似症狀。個案居家檢疫期間，提出外出奔喪申請，於11月26日由衛生單位安排自費採檢，因檢出陽性於今（28）日確診。
