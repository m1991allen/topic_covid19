...
case_data.list = [
    {
        ...
        group: 'trp_EU',
        info: '《案745》' + '<br>' + `
            案745、746、747、748為俄羅斯籍藝文表演團體成員，共2男2女，年齡介於20至60多歲，因受邀來台參演，於今年11月29日入境，皆持有登機前3日內核酸檢驗陰性報告，入境後至防疫旅館檢疫，迄今皆無症狀；12月14日檢疫期滿後，由邀請單位安排自費採檢，均於今（16）日確診。
        ...
        group: 'trp_A',
        info: '《案749》' + '<br>' + `
            菲律賓籍20多歲男性漁工，今年11月29日來台工作，持有登機前3日內核酸檢驗陰性報告，入境後至防疫旅館檢疫，迄今無症狀。個案12月14日檢疫期滿後，由仲介安排自費採檢，於今（16）日確診。
        ...
        group: 'trp_NA',
        info: '《案750》' + '<br>' + `
            本國籍40多歲男性，今年3月前往美國探親，12月8日入境台灣後返回住處居家檢疫，持有登機前3日內核酸檢驗陰性報告。個案曾於12月11日及12日出現畏寒及發燒等症狀，13日因出現嗅味覺異常症狀由衛生單位安排就醫採檢，於今（16）日確診。
