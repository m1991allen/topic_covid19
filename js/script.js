$(document).ready(function () {
    ...
    document.querySelector('.localurl-style').addEventListener('click', function () {
        ...
        new Splide('#splide_station', { rewind: !0 }).mount(),
        new Splide('#splide_booking', { rewind: !0 }).mount(),
        new Splide('#splide_alert', { rewind: !0 }).mount()
}),
    (function () {
        let e = document.querySelectorAll('.ctrl>td:nth-child(2)')
        setTimeout(() => {
            for (let t = 0; t < e.length; t++) '0' === e[t].innerHTML && (e[t].parentNode.style.display = 'none')
        }, 1e3)
    })()
